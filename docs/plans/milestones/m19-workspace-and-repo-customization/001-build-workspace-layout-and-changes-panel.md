...
## Deliverables
- [ ] `apps/ui/src/pages/SessionDetailPage.tsx` introduces workspace panes/tabs for steering, trace, changes, and logs.
- [ ] `apps/ui/src/components/ChangesPanel.tsx` renders grouped changed files and patch outcomes by attempt.
- [ ] UI tests verify pane persistence and usability on long-running sessions.
