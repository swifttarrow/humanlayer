...
## Deliverables
- [x] `apps/cli/package.json` defines workspace metadata and `bin` entrypoint.
- [x] `apps/cli/src/index.ts` implements command parsing, auth, target environment selection, and API-backed run execution.
- [x] Exit code handling maps success and common failure classes to deterministic codes.
