...
## Deliverables
- [ ] `apps/ui/src/pages/NewSessionPage.tsx` includes a `working_directory` input
- [ ] Optional exposed-surfaces controls are available when configured
- [ ] Form state persists entered values across submit attempts
