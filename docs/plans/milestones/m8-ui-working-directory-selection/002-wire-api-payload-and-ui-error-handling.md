...
## Deliverables
- [ ] `apps/ui/src/api.ts` request typings include `workingDirectory` and optional `exposedSurfaces`
- [ ] `apps/ui/src/pages/SessionsPage.tsx` or related submit flow sends workdir payload unchanged
- [ ] `apps/ui/src/__tests__/new-session.test.tsx` verifies failure feedback and retry behavior
