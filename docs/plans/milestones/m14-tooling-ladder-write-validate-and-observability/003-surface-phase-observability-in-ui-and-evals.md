...
## Deliverables
- [x] `apps/ui/src/components/StructuredTrace.tsx` renders phase and blocked semantics
- [x] `apps/ui/src/components/RawEventsPanel.tsx` supports new phase/terminal event labels
- [x] `apps/server/src/evals/mvpEvalRunner.ts` and `docs/evals/mvp-eval-spec.md` include requirement acceptance checks
