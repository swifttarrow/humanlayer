...
## Deliverables
- [x] Root `package.json` defines workspaces and baseline scripts (`dev`, `build`, `typecheck`, `lint`, `test`)
- [x] `apps/server`, `apps/agent`, `apps/ui`, and `packages/shared` directories exist with initial package manifests and entry files
